...
namespace Tiled2Bin
{
    partial class Tiled2Bin
    {
        ...
        {
            Console.WriteLine("Usage: Tiled2Bin <filename> [-512] [-blank=n] [-zx0] [-rle] [-q] [-b] [-noheader] [-split] [-slice] [-tilesize=x] [-norepeat] [-nomirror] [-norotate] [-insertblanktile]\n");
            ...
            Console.WriteLine("-noheader           Don't output the header. Default is false.");
